...
public class UtilDigitalTrans {
    ...
    public static String hexStringToString(String hexString, int encodeType) {
        ...
        for (int i = 0; i < max; i++) {
            char c = (char) UtilDigitalTrans.hexStringToAlgorism(hexString
    ...
    public static byte[] hexStringToByte(String hex) {
        ...
        String binarys = UtilDigitalTrans.hexStringToBinary(hex);
        for (int i = 0; i < max; i++) {
            bytes[i] = (byte) UtilDigitalTrans.binaryToAlgorism(binarys.substring(
                    i * 8 + 1, (i + 1) * 8));
     ...
     * 十六进制转换字符串
     *
     * @paramString str Byte字符串(Byte之间无分隔符 如:[616C6B])
     ...
     */
    public static String byte2HexStr(byte[] b, int length, boolean bWithSpace) {
        String stmp = "";
        StringBuilder sb = new StringBuilder("");
     ...
     * bytes字符串转换为Byte值
     *
     * @paramString src Byte字符串，每个Byte之间没有分隔符
     * @return byte[]
     */
